...
#else
#define STE_HWC_DEVICE_API_CURRENT HWC_DEVICE_API_VERSION_1_0
#endif
...
static int hwcomposer_blank(struct hwc_composer_device_1 *dev, int dpy, int blank)
{
    // we do nothing here //XXX: is that good enough?
    return 0;
}
 ...
 */
static void handle_fences(size_t numDisplays, hwc_display_contents_1_t** displays)
{
...
static int hwcomposer_set(struct hwc_composer_device_1 *dev, size_t numDisplays, hwc_display_contents_1_t** displays)
{
    ...
    //handle_fences(numDisplays, displays);
